...
@Component({
  selector: 'ZipCodeReport-home',
  templateUrl: './ZipCodeReport-home.component.html',
  styleUrls: ['./ZipCodeReport-home.component.scss']
})
export class ZipCodeReportHomeComponent implements AfterViewInit {
