...
@Component({
  selector: 'ZipCodeDatum-home',
  templateUrl: './ZipCodeDatum-home.component.html',
  styleUrls: ['./ZipCodeDatum-home.component.scss']
})
export class ZipCodeDatumHomeComponent implements AfterViewInit {
