...
@Component({
  selector: 'UserInteraction-home',
  templateUrl: './UserInteraction-home.component.html',
  styleUrls: ['./UserInteraction-home.component.scss']
})
export class UserInteractionHomeComponent implements AfterViewInit {
