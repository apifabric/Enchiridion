...
@Component({
  selector: 'Neighborhood-home',
  templateUrl: './Neighborhood-home.component.html',
  styleUrls: ['./Neighborhood-home.component.scss']
})
export class NeighborhoodHomeComponent implements AfterViewInit {
