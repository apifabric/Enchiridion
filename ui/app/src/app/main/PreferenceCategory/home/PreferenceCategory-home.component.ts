...
@Component({
  selector: 'PreferenceCategory-home',
  templateUrl: './PreferenceCategory-home.component.html',
  styleUrls: ['./PreferenceCategory-home.component.scss']
})
export class PreferenceCategoryHomeComponent implements AfterViewInit {
