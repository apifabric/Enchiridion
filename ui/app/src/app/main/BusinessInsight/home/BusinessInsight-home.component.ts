...
@Component({
  selector: 'BusinessInsight-home',
  templateUrl: './BusinessInsight-home.component.html',
  styleUrls: ['./BusinessInsight-home.component.scss']
})
export class BusinessInsightHomeComponent implements AfterViewInit {
