...
@Component({
  selector: 'BehavioralPattern-home',
  templateUrl: './BehavioralPattern-home.component.html',
  styleUrls: ['./BehavioralPattern-home.component.scss']
})
export class BehavioralPatternHomeComponent implements AfterViewInit {
