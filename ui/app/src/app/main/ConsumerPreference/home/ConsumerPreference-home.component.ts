...
@Component({
  selector: 'ConsumerPreference-home',
  templateUrl: './ConsumerPreference-home.component.html',
  styleUrls: ['./ConsumerPreference-home.component.scss']
})
export class ConsumerPreferenceHomeComponent implements AfterViewInit {
